...
class ParseError(Exception):
    ...
    def __init__(self, msg, type, value, start_pos):
        Exception.__init__(self, f"{msg}: type={tokenize.tok_name[type]!r}, value={value!r}, start_pos={start_pos!r}")
        self.msg = msg
        self.type = type
        self.value = value
...
class PgenParser:
    ...
    def addtoken(self, type, value, prefix, start_pos) -> bool | None:
    ...
    def shift(self, type, value, newstate, prefix, start_pos) -> None:
    ...
    def push(self, type, newdfa, newstate) -> None:
    ...
    def pop(self) -> None:
        ...
        newnode = children[0] if len(children) == 1 else self.convert_node(self.grammar, type, children)
