...
# Generated by "Tools/cython-generate-shadow-pyi.py" on 2025-11-01 20:54:21.248297

const_bint : TypeAlias = const[py_bint]
p_const_bint = pointer[const[py_bint]]
pp_const_bint = pointer[pointer[const[py_bint]]]
ppp_const_bint = pointer[pointer[pointer[const[py_bint]]]]
p_bint = pointer[py_bint]
pp_bint = pointer[pointer[py_bint]]
ppp_bint = pointer[pointer[pointer[py_bint]]]
...
CythonCImports = py_CythonCImports
CythonDotImportedFromElsewhere = py_CythonDotImportedFromElsewhere
CythonDotParallel = py_CythonDotParallel
double : TypeAlias = py_double
const_double : TypeAlias = const[py_double]
p_const_double = pointer[const[py_double]]
pp_const_double = pointer[pointer[const[py_double]]]
ppp_const_double = pointer[pointer[pointer[const[py_double]]]]
p_double = pointer[py_double]
pp_double = pointer[pointer[py_double]]
ppp_double = pointer[pointer[pointer[py_double]]]
doublecomplex : TypeAlias = py_doublecomplex
const_doublecomplex : TypeAlias = const[py_doublecomplex]
p_const_doublecomplex = pointer[const[py_doublecomplex]]
pp_const_doublecomplex = pointer[pointer[const[py_doublecomplex]]]
ppp_const_doublecomplex = pointer[pointer[pointer[const[py_doublecomplex]]]]
p_doublecomplex = pointer[py_doublecomplex]
pp_doublecomplex = pointer[pointer[py_doublecomplex]]
ppp_doublecomplex = pointer[pointer[pointer[py_doublecomplex]]]
...
floatcomplex : TypeAlias = py_floatcomplex
const_floatcomplex : TypeAlias = const[py_floatcomplex]
p_const_floatcomplex = pointer[const[py_floatcomplex]]
pp_const_floatcomplex = pointer[pointer[const[py_floatcomplex]]]
ppp_const_floatcomplex = pointer[pointer[pointer[const[py_floatcomplex]]]]
p_floatcomplex = pointer[py_floatcomplex]
pp_floatcomplex = pointer[pointer[py_floatcomplex]]
ppp_floatcomplex = pointer[pointer[pointer[py_floatcomplex]]]
...
longdouble : TypeAlias = py_longdouble
const_longdouble : TypeAlias = const[py_longdouble]
p_const_longdouble = pointer[const[py_longdouble]]
pp_const_longdouble = pointer[pointer[const[py_longdouble]]]
ppp_const_longdouble = pointer[pointer[pointer[const[py_longdouble]]]]
p_longdouble = pointer[py_longdouble]
pp_longdouble = pointer[pointer[py_longdouble]]
ppp_longdouble = pointer[pointer[pointer[py_longdouble]]]
longdoublecomplex : TypeAlias = py_longdoublecomplex
const_longdoublecomplex : TypeAlias = const[py_longdoublecomplex]
p_const_longdoublecomplex = pointer[const[py_longdoublecomplex]]
pp_const_longdoublecomplex = pointer[pointer[const[py_longdoublecomplex]]]
ppp_const_longdoublecomplex = pointer[pointer[pointer[const[py_longdoublecomplex]]]]
p_longdoublecomplex = pointer[py_longdoublecomplex]
pp_longdoublecomplex = pointer[pointer[py_longdoublecomplex]]
ppp_longdoublecomplex = pointer[pointer[pointer[py_longdoublecomplex]]]
...
ptrdiff_t : TypeAlias = py_ptrdiff_t
const_ptrdiff_t : TypeAlias = const[py_ptrdiff_t]
p_const_ptrdiff_t = pointer[const[py_ptrdiff_t]]
pp_const_ptrdiff_t = pointer[pointer[const[py_ptrdiff_t]]]
ppp_const_ptrdiff_t = pointer[pointer[pointer[const[py_ptrdiff_t]]]]
p_ptrdiff_t = pointer[py_ptrdiff_t]
pp_ptrdiff_t = pointer[pointer[py_ptrdiff_t]]
ppp_ptrdiff_t = pointer[pointer[pointer[py_ptrdiff_t]]]
...
Py_ssize_t : TypeAlias = py_ssize_t
const_Py_ssize_t : TypeAlias = const[py_ssize_t]
p_const_Py_ssize_t = pointer[const[py_ssize_t]]
pp_const_Py_ssize_t = pointer[pointer[const[py_ssize_t]]]
ppp_const_Py_ssize_t = pointer[pointer[pointer[const[py_ssize_t]]]]
p_Py_ssize_t = pointer[py_ssize_t]
pp_Py_ssize_t = pointer[pointer[py_ssize_t]]
ppp_Py_ssize_t = pointer[pointer[pointer[py_ssize_t]]]
Py_tss_t : TypeAlias = py_tss_t
const_Py_tss_t : TypeAlias = const[py_tss_t]
p_Py_tss_t = pointer[py_tss_t]
pp_Py_tss_t = pointer[pointer[py_tss_t]]
ppp_Py_tss_t = pointer[pointer[pointer[py_tss_t]]]
...
const_void : TypeAlias = const[py_void]
p_void = pointer[py_void]
pp_void = pointer[pointer[py_void]]
ppp_void = pointer[pointer[pointer[py_void]]]
