...
#if !defined(__Pyx_RaiseKeywordRequired_DEFINED) && !defined(__PYX_FASTARG_ERROR_HELPERS)
#define __Pyx_RaiseKeywordRequired_DEFINED
...
#if !defined(__Pyx_RaiseUnexpectedKeywordError_DEFINED) && !defined(__PYX_FASTARG_ERROR_HELPERS)
...
#if !defined(__Pyx_RaiseUnexpectedKeywordError_DEFINED) && !defined(__PYX_FASTARG_ERROR_HELPERS)
#define __Pyx_RaiseUnexpectedKeywordError_DEFINED
...
#define __PYX_PARAM_IS_POSONLY    0x08u

#define __PYX_FASTPARSE_SUCCESS          0
#define __PYX_FASTPARSE_ERROR           (-1)
