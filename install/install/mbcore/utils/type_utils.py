...
if TYPE_CHECKING:
    ...
    try:
        ...
        cv2 = SimpleNamespace({"gapi": SimpleNamespace({"wip": SimpleNamespace({"draw": object})}), "dnn": object})
        numpy = SimpleNamespace({"ndarray": object, "dtype": object, "integer": object, "floating": object})
...
LayerParams = _typing.Dict[str, int | float | str]
IndexParams = _typing.Dict[str, bool | int | float | str]
SearchParams = _typing.Dict[str, bool | int | float | str]
