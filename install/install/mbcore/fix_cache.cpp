...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "language": "c++",
        "name": "install.mbcore.fix_cache",
        "sources": [
            "/Users/sebastianperalta/simply/corp/projects/cython/install/mbcore/fix_cache.py"
        ]
    },
    "module_name": "install.mbcore.fix_cache"
}
END: Cython Metadata */
...
#define __PYX_HAVE__install__mbcore__fix_cache
#define __PYX_HAVE_API__install__mbcore__fix_cache
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "install.mbcore.fix_cache" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "install.mbcore.fix_cache"
extern int __pyx_module_is_main_install__mbcore__fix_cache;
int __pyx_module_is_main_install__mbcore__fix_cache = 0;

/* Implementation of "install.mbcore.fix_cache" */
...
static int __pyx_pymod_exec_fix_cache(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_fix_cache},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_fix_cache(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_fix_cache(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_fix_cache(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'fix_cache' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "fix_cache" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_fix_cache", 0);
  ...
  if (__pyx_module_is_main_install__mbcore__fix_cache) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "install.mbcore.fix_cache")) {
      if (unlikely((PyDict_SetItemString(modules, "install.mbcore.fix_cache", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init install.mbcore.fix_cache", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init install.mbcore.fix_cache");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
