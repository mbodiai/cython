...
from typing import IO, Any, Callable, List, TextIO, Type, cast
        ...
        with self._lock:
            ...
            if self.auto_refresh:
                if self._refresh_thread and self._refresh_thread.is_alive():
                    self._refresh_thread.stop()  # Ensure previous thread stops
    ...
    def stop(self) -> None:
        ...
        with self._lock:
            ...
            if self.auto_refresh and self._refresh_thread is not None:
                ...
                self._refresh_thread.join(timeout=1)  # Ensure the thread terminates
