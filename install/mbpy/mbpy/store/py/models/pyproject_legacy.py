...
class DataModel(namespace[T], Generic[T], metaclass=DCMeta): ...
...
class Project(DataModel):
    ...
    name: Annotated[
        str, StringConstraints(pattern=r"^([a-zA-Z\d]|[a-zA-Z\d][\w.-]*[a-zA-Z\d])$")
    ] = Field(
        ...,
        title="Project name",
    )
    ...
    optional_dependencies: (
        Dict[constr(pattern="^([a-z\\d]|[a-z\\d][a-z\\d-]*[a-z\\d])$"), List[str]]
        | None
    ) = Field(
        None,
        alias="optional-dependencies",
...
class Project1(DataModel):
    ...
    optional_dependencies: (
        Dict[
            Annotated[
                str,
                StringConstraints(pattern="^([a-z\\d]|[a-z\\d][a-z\\d-]*[a-z\\d])$"),
            ],
            List[str],
        ]
        | None
...
class Override1(DataModel):
    ...
    follow_imports: FollowImports | None = FollowImports.normal
...
class PartialSetuptools(DataModel):
    ...
    platforms: List[str] | None = Field(None)
