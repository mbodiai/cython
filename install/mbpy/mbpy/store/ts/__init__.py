...
def parse_schema(
    ...
    for prop, details in properties.items():
        ...
        field_type, imports = get_field_type(
            prop, details, models, processed, root_schema
        )
        fields[field_name] = {
            "type": field_type,
...
def get_field_type(
    ...
    if json_type == "array":
        ...
        item_type, item_imports = get_field_type(
            prop, items, models, processed, root_schema
        )
