...
_c_parser = c_parser.CParser(
    lex_optimize=False, yacc_debug=True, yacc_optimize=False, yacctab="yacctab"
)
...
class TestCParser_fundamentals(TestCParser_base):
    ...
    def test_decl_inits(self):
        ...
        self.assertEqual(self.get_decl_init(d1_1), ["Constant", "float", "0xEF.56p1"])
        ...
        self.assertEqual(self.get_decl_init(d55), ["Constant", "float", "0xDE.38p0"])
