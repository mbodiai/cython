...
class CGenerator:
    ...
    def visit_Assignment(self, n) -> str:
        rval_str = self._parenthesize_if(
    ...
    def visit_Alignas(self, n) -> str:
        return f"_Alignas({self.visit(n.alignment)})"

    def visit_Enumerator(self, n) -> str:
        if not n.value:
    ...
    def visit_EmptyStatement(self, n) -> str:
        return ";"
    ...
    def visit_Break(self, n) -> str:
        return "break;"

    def visit_Continue(self, n) -> str:
        return "continue;"
    ...
    def visit_EllipsisParam(self, n) -> str:
        return "..."
