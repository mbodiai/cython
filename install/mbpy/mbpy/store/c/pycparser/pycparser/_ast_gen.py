...
class NodeCfg:
    ...
    def _gen_children(self):
        ...
        if self.all_entries:
            ...
            for seq_child in self.seq_child:
                src += (
                    "        for i, child in enumerate(self.{child} or []):\n"
                    '            nodelist.append(("{child}[%d]" % i, child))\n'
                ).format(**{"child": seq_child})
    ...
    def _gen_attr_names(self):
        return "    attr_names = (" + "".join(f"{nm!r}, " for nm in self.attr) + ")"
