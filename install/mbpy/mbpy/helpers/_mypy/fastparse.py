...
# import sys
# import warnings
# from typing import Any, Callable, Final, List, Sequence, TypeVar, Union, cast
...
#     if isinstance(expr, Attribute) and isinstance(expr.value, Name):
...
#     def do_func_def(
#         self,
#         n: ast3.FunctionDef | ast3.AsyncFunctionDef,
#         is_coroutine: bool = False,
#     ) -> FuncDef | Decorator:
...
#                 self.errors,
#                 line=n.returns.lineno if n.returns else lineno,
#             ).visit(n.returns)
...
#             zip(args_args[num_no_defaults:], args_defaults, strict=False)
#         ):
...
#         e = (
#             OpExpr(op, vals[0], vals[1])
#             if len(vals) == 2
#             else OpExpr(op, vals[0], self.group(op, vals[1:], n))
#         )
...
#             if constructor:
#                 note = (
#                     f"Suggestion: use {constructor}[...] instead of {constructor}(...)"
#                 )
...
#         items: dict[str, Type] = {}
#         extra_items_from = []
#         for item_name, value in zip(n.keys, n.values, strict=False):
