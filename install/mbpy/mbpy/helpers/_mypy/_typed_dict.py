...
from typing import TYPE_CHECKING, Callable, Final, Type
...
try:
    ...
    from mypy.nodes import ClassDef, ImportFrom, MypyFile, Statement, TypeInfo
    ...
    def _index(iterable: Iterable[Statement], id: str) -> int:
        ...
        for i, value in enumerate(iterable):
            if getattr(value, "id", None) == id:
                return i
        raise ValueError(
            f"Failed to identify a `ImportFrom` instance with the following id: {id!r}"
        )
