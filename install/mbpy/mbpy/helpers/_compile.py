...
from mbpy.helpers._dist import Command, PlatformError, is_mingw, passnone, split_quoted
...
class CCompiler:
    ...
    def has_function(  # noqa: C901
        ...
        if includes is None:
            ...
            warnings.warn("includes is deprecated", DeprecationWarning, stacklevel=2)
        if include_dirs is None:
            include_dirs = []
        else:
            warnings.warn(
                "include_dirs is deprecated", DeprecationWarning, stacklevel=2
            )
        if libraries is None:
            libraries = []
        if library_dirs is None:
